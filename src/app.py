...
def get_top_rows(job_title, num_pages, conditions, top_k):
    # df = main(job_title, num_pages, conditions=conditions, top_k=top_k)
...
def index():
    if request.method == 'POST':
        ...
        df = get_top_rows(job_title, num_pages, job_levels, top_k)
